        ...
        <div className='flex flex-col gap-3 items-center justify-center'>
            ...
            <div className='mt-2 flex flex-col'>
                ...
                <div className='flex flex-col gap-8 items-center md:flex-row md:gap-8 md:items-center'>
                    <img className='size-1/3 md:size-2/3' src={c1} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c2} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c3} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c4} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c5} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c6} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c7} alt="" />
                    <img className='size-1/3 md:size-2/3' src={c8} alt="" />
                </div>
            </div>
